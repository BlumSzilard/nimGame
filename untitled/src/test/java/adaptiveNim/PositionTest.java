...
class PositionTest {
    ...
    void testSetRating() {
        ...
        position.setRating(Rating.WINNER);
        assertEquals(Rating.WINNER, position.getRating());
    ...
    void testSetLevel2and3() {
        ...
        assertEquals(2, position.getVisibleAboveLevel());
        ...
        assertEquals(3, position.getVisibleAboveLevel());
    ...
    void testSetLevel4and5() {
        ...
        assertEquals(4, position.getVisibleAboveLevel());
        ...
        assertEquals(5, position.getVisibleAboveLevel());
    ...
    void testSetLevel6_7and8() {
        ...
        assertEquals(6, position.getVisibleAboveLevel());

        position = new Position(1, 6, 4, 3);
        position.setRating(Rating.WINNER);

        assertEquals(7, position.getVisibleAboveLevel());

        position = new Position(6, 5, 5, 6);
        position.setRating(Rating.WINNER);

        assertEquals(8, position.getVisibleAboveLevel());
    }
